...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children, title }) => {
  ...
  const navItems = [
    ...
    { name: 'Drivers', icon: <Users size={20} />, path: '/admin/drivers' },
          ...
          <div className="flex h-16 items-center justify-between px-4">
            ...
            <div className="flex items-center space-x-4">
              <button className="relative text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white">
                <Bell size={20} />
                <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs text-white">3</span>
              </button>
              ...
              <div className="relative">
                <div className="flex items-center space-x-3">
                  ...
                  <img
                    ...
                    src={currentUser?.avatarUrl || "https://i.pravatar.cc/150?img=68"}
                    alt="User avatar"
                  />
                </div>
              </div>
